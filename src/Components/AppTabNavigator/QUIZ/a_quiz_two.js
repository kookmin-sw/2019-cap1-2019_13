...
export default class  a_quiz_two extends React. Component {
    ...
    render() {
        ...
        return (
          ...
          <TouchableOpacity onPress={() =>Tts.speak("초성 'ㄷ'은 무엇인가요?",{language:"ko"})}style={{backgroundColor:'orange',position: 'absolute',top:40,left:10,borderRadius: 5 }}>
...
<TouchableOpacity   onPress={() => {this.props.navigation.navigate('a_quiz_three'); Tts.speak("다음문제",{language:"ko"});}} style={{backgroundColor:'orange',position: 'absolute',top:40,right:10,borderRadius: 5 }}>
...
<TouchableOpacity onPress={()=>{this.press(); Tts.speak(number1check,{language:"ko"});}} style={{ backgroundColor:checkchange, position: 'absolute',left:60,paddingTop:10, paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10}}>
      ...
      <Image style={{ position:'absolute' , top:350, alignItems :'center' }}  source={require('../QUIZ/Images/siss.png')}/>
