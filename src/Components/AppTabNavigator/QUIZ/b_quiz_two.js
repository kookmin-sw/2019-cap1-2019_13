    ...
    render() {
        ...
        return (
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' , margin:10 , backgroundColor:'bisque'}}>
             ...
             <TouchableOpacity onPress={() => Tts.speak(" 모음'ㅘ'는 무엇인가요?",{language:"ko"})}style={{backgroundColor:'orange',position: 'absolute',top:40,left:10,borderRadius: 5 }}>
...
<TouchableOpacity onPress={()=>{this.press(); Tts.speak(number1check,{language:"ko"});}} style={{ backgroundColor:checkchange, position: 'absolute',left:60,paddingTop:10, paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10}}>
      ...
      <Image style={{ position:'absolute' , top:350,left:50 }} source={require('../QUIZ/Images/di.png')} />

      <Image style={{ position:'absolute' , top:350, alignItems :'center' }}  source={require('../QUIZ/Images/waa.png')}/>

      <Image style={{ position:'absolute' , top:350,right:50 }}  source={require('../QUIZ/Images/wa.png')}/>
