...
export default class  a_quiz_three extends React. Component {
    ...
    render() {
        ...
        return (
          ...
          <TouchableOpacity onPress={() => Tts.speak("종성 'ㅅ'은 무엇인가요?",{language:"ko"})}style={{backgroundColor:'orange',position: 'absolute',top:40,left:10,borderRadius: 5 }}>
...
<TouchableOpacity   onPress={() => {this.props.navigation.navigate('quizstart'); Tts.speak("다음문제",{language:"ko"});}} style={{backgroundColor:'orange',position: 'absolute',top:40,right:10,borderRadius: 5 }}>
...
<TouchableOpacity onPress={()=>{this.press(); Tts.speak(number1check,{language:"ko"});}} style={{ backgroundColor:checkchange, position: 'absolute',left:60,paddingTop:10, paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10}}>
      ...
      <Image style={{ position:'absolute' , top:350,left:50 }} source={require('../QUIZ/Images/ni.png')} />

      <Image style={{ position:'absolute' , top:350, alignItems :'center' }}  source={require('../QUIZ/Images/jong_si.png')}/>

      <Image style={{ position:'absolute' , top:350,right:50 }}  source={require('../QUIZ/Images/u.png')}/>
      ...
      <TouchableOpacity  onPress={() => {Alert.alert('2번');  Tts.speak("정답은 2번입니다" , {language:"ko"});}}  style={{backgroundColor:'orange', position:'absolute',paddingTop:10,paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10 ,  bottom :80 ,right:200  }}>
