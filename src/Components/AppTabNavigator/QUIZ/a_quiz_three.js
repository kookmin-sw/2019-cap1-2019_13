...
export default class a_quiz_three extends Component {
    ...
    constructor(props) {
        ...
        Tts.speak("자음퀴즈입니다 종성 'ㅅ'은 몇번인가요??",{language:"ko"});
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',backgroundColor :'bisque'  }}>
           ...
           {this.state.partialResults.map((result, index) => {
               ...
               <Text key={`partial-result-${index}`} >{result == "문제"?  Tts.speak("자음퀴즈입니다 종성 'ㅅ'은 몇번인가요",{language:"ko"}):''}{result == "다음"? this.props.navigation.navigate('quizstart') :''}
      ...
      <TouchableOpacity style={{backgroundColor:'black', position:'absolute',right:-20,paddingTop:10,paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10 ,  bottom :80   }}   
       ...
       AppRegistry.registerComponent('a_quiz_three', () => a_quiz_three);