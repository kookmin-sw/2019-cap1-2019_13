    ...
    render() {
        ...
        return (
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' , margin:10,backgroundColor:'bisque'}}>
           ...
           <TouchableOpacity onPress={() => Tts.speak(" 약자 받침 'ㅆ'은 무엇인가요?",{language:"ko"})}style={{backgroundColor:'orange',position: 'absolute',top:40,left:10,borderRadius: 5 }}>
...
<TouchableOpacity   onPress={() => {this.props.navigation.navigate('c_quiz_two'); Tts.speak("다음문제",{language:"ko"});}} style={{backgroundColor:'orange',position: 'absolute',top:40,right:10,borderRadius: 5 }}>
...
<TouchableOpacity onPress={()=>{this.press(); Tts.speak(number1check,{language:"ko"});}} style={{ backgroundColor:checkchange, position: 'absolute',left:60,paddingTop:10, paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10}}>
      ...
      <Image style={{ position:'absolute' , top:360,left:50 }} source={require('../QUIZ/Images/gi.png')} />

      <Image style={{ position:'absolute' , top:360, alignItems :'center' }}  source={require('../QUIZ/Images/ni.png')}/>

      <Image style={{ position:'absolute' , top:360,right:50 }}  source={require('../QUIZ/Images/siss.png')}/>
    ...
    <TouchableOpacity  onPress={() => { Tts.speak("처음으로 돌아가기" , {language:"ko"}); this.props.navigation.navigate('quizstart');  }}  style={{backgroundColor:'orange', position:'absolute',left:200,paddingTop:10,paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10 ,  bottom :80   }}>
      ...
      <TouchableOpacity  onPress={() => {Alert.alert('3번');  Tts.speak("정답은 3번입니다" , {language:"ko"});}}  style={{backgroundColor:'orange', position:'absolute',paddingTop:10,paddingBottom:10, paddingLeft:20, paddingRight:20, borderRadius: 10 ,  bottom :80 ,right:200  }}>
