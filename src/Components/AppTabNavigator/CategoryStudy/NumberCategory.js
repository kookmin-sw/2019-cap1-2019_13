            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("1", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("2", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("3", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("4", { language: 'ko', rate: 0.75 })} style={styles.button}>
