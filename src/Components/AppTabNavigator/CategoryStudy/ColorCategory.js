            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("빨강", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("노랑", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("초록", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("파랑", { language: 'ko', rate: 0.75 })} style={styles.button}>
