...
class Animal extends Component {
    ...
    render() {
        const {goBack} = this.props.navigation;
        const device_dot_in_animal = this.props.navigation.getParam('deviceinfo2', 'cantread');
        console.log("device info in animal: ", device_dot_in_animal.id);
            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>{Tts.speak("개", { language: 'ko', rate: 0.75 }); this.write(device_dot_in_animal.id, "2000100111010F");}} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>{Tts.speak("새", { language: 'ko', rate: 0.75 }); this.write(device_dot_in_animal.id, "2000001111010F");}} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>{Tts.speak("사자", { language: 'ko', rate: 0.75 }); this.write(device_dot_in_animal.id, "2111000000101F");}} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>{Tts.speak("말", { language: 'ko', rate: 0.75 }); this.write(device_dot_in_animal.id, "3100010110001010000F");}} style={styles.button}>
