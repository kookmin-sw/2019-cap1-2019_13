...
export default class MoumQuiz1 extends Component {
    ...
    <TouchableOpacity style={{ flex: 0.9 }}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                        <TouchableOpacity style={styles.buttonst} onPress={() => {Tts.speak("모음퀴즈입니다 모음 'ㅓ'는 몇번인가요", {language:"ko"});}} >
                        ...
                        <TouchableOpacity style={styles.buttonst} onPress={() => {this.props.navigation.navigate('MoumQuiz2');}} >
