...
export default class JaumQuiz2 extends Component {
    constructor(props) {
        super(props);
        this.mounted = false;
        this.state = {
        ...
        Tts.speak("자음퀴즈입니다 초성ㄷ은 몇번인가요?",{language:"ko"});
    ...
    onSpeechPartialResults(e) {
        ...
        if (speech.includes("문제")) {
            Tts.speak("자음퀴즈입니다. 초성 'ㄷ'은 무엇인가요?", {language:"ko"});
            this.setState({
                results: '',
    ...
    <TouchableOpacity style={{ flex: 0.9 }}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                        <TouchableOpacity style={styles.buttonst} onPress={() => {Tts.speak("자음퀴즈입니다. 초성 'ㄷ'은 무엇인가요?", {language:"ko"});}} >
                        ...
                        <TouchableOpacity style={styles.buttonst} onPress={() => {this.props.navigation.navigate('JaumQuiz3');}} >
