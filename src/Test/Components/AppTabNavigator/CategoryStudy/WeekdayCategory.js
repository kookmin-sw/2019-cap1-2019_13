            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("월", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("화", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("수", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("금", { language: 'ko', rate: 0.75 })} style={styles.button}>
