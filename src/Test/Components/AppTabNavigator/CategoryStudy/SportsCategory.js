            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("축구", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("야구", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("농구", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Speech.speak("골프", { language: 'ko', rate: 0.75 })} style={styles.button}>
