    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' , margin:10,backgroundColor : 'bisque'}}>
        <Text
          ...
          QUIZ!</Text>
        <TouchableOpacity onPress={() => this.props.navigation.navigate('quizstart')} style={{backgroundColor:'orange',position: 'absolute',top:40,right:60,borderRadius: 5 }}>
          <Text
      ...
      <Image style={{ position:'absolute' , top:360,left:50 }} source={require('./Images/ni.png')} />
      <Image style={{ position:'absolute' , top:360, alignItems :'center' }}  source={require('./Images/jong_si.png')}/>
      <Image style={{ position:'absolute' , top:360,right:50 }}  source={require('./Images/u.png')}/>

      <TouchableOpacity  onPress={() => {Alert.alert('2번');}}  style={{backgroundColor:'orange',                            position:'absolute',alignItems:"center",paddingTop:10,paddingBottom:10, paddingLeft:20, paddingRight:20,           borderRadius: 10 ,  bottom :80   }}>
