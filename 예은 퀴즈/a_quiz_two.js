    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' , margin:10,backgroundColor : 'bisque'}}>
        <Text
          ...
          QUIZ!</Text>
        <TouchableOpacity onPress={() => this.props.navigation.navigate('a_quiz_three')} style={{backgroundColor:'orange',position: 'absolute',top:40,right:60,borderRadius: 5 }}>
      ...
      <Image style={{ position:'absolute' , top:360, alignItems :'center' }}  source={require('./Images/siss.png')}/>
