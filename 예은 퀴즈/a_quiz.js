    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' , margin:10,backgroundColor : 'bisque'}}>
        <Text
          ...
          QUIZ!</Text>
        <TouchableOpacity onPress={() => this.props.navigation.navigate('a_quiz_two')} style={{backgroundColor:'orange',position: 'absolute',top:40,right:60,borderRadius: 5 }}>
          <Text
      ...
      <Image style={{ position:'absolute' , top:360,right:50 }}  source={require('/Images/di.png')}/>
