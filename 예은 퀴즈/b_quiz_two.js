 ...
 state = {
  ...
  render() {
    ...
    return (
      ...
      <Image style={{ position:'absolute' , top:360,left:50 }} source={require('./Images/di.png')} />
      <Image style={{ position:'absolute' , top:360, alignItems :'center' }}  source={require('./Images/waa.png')}/>
      <Image style={{ position:'absolute' , top:360,right:50 }}  source={require('./Images/wa.png')}/>
