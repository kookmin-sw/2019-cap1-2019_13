            ...
            <View style={ styles.container }>
                ...
                <View style={styles.syllables}>
                    <View style={{ flexDirection:'row' }}>
                        ...
                        <TouchableOpacity 
                        onPress={()=>{this; Tts.speak("ㄴ", { language: "ko", rate : 0.75 });}}  style={styles.button}>
                    ...
                    <View style={{ flexDirection:'row' }}>
                        <TouchableOpacity 
                        onPress={()=>{this; Tts.speak("ㅅ", { language: "ko", rate : 0.75 });}}  style={styles.button}>
                            <Text style={styles.text}>ㅅ</Text>
                        </TouchableOpacity>
                        <TouchableOpacity 
                        onPress={()=>{this; Tts.speak("ㅇ", { language: "ko", rate : 0.75 });}}  style={styles.button}>
