            ...
            <View style={styles.container}>
                ...
                showsVerticalScrollIndicator={false}>
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("개", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("새", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("사자", { language: 'ko', rate: 0.75 })} style={styles.button}>
                    ...
                    <View style={styles.card}>
                        ...
                        <TouchableOpacity onPress={()=>Tts.speak("말", { language: 'ko', rate: 0.75 })} style={styles.button}>
